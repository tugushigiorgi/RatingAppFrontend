...
const [state, seState] = useState({ischanged:false,Successmessage:'', userInputErrorsData:[],id:itemtoUpdate.id, title: itemtoUpdate.title, text: itemtoUpdate.text ,
         price: itemtoUpdate.price, photo: itemtoUpdate.photo, uploaddate: itemtoUpdate.uploaddate});
    ...
    //    setUserInputErrorsData([]);
        ...
        if (errors.length === 0) {
             ...
             try {
                    ...
                    // if(state.ischanged ){
                    //     updateItemHandler(state)
                    // }
               // TO DO  updateItemHandler(state);
           ...
           <div className={style.modalcontent}>
             ...
             <div className={style.Inputcontainer}>
                    ...
                    <div className={style.Inputcontainer}>
                        ...
                        <input className={style.inp} value={state.price} name="price" onInput={ handleGetInputData}    type="number" required={true} />


                    </div>
                    <div className={style.InputTitle}>Picture</div>
                    <img src={state.photo} alt="Item" className={style.ItemImage}/>
                    <div className={style.Inputcontainer}>
