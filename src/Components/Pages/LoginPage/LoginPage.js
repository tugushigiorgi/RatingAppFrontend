                ...
                if (result.success) {
                   if(result.role==="ADMIN"){
                    ...
                    setState(prevState => ({
                        ...prevState,
                        isloading: false,
                        userInputErrorsData: [result.error]
                    }));
                }
            } catch (error) {
                setState(prevState => ({
                    ...prevState,
                    isloading: false,
                    userInputErrorsData: ["Unexpected error. Please try again."]
                }));
            }
            ...
            <div className={style.Loginwrapper}>
                <div className={style.Logincontainer}>
                    ...
                    <div className={style.Inputcontainer}>
                        ...
                        <input className={style.inp} name="email" onInput={handleGetLoginData} type="text"
                               required={true}/>
                    ...
                    <div className={style.Inputcontainer}>
                        ...
                        <input className={style.inp} name="password" onInput={handleGetLoginData} type="password"
                               required={true}/>


                    </div>
                    <div>
                        <button onClick={() => openResetModal()} className={style.forgotpasslink}>Forgot Password?
                        </button>
                    </div>
                ...
                progress_activity
                        ...
                        <div className={style.footertitle}>Don't have account ? <Link className={style.signuplink}
