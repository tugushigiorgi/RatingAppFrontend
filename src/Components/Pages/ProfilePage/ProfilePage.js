            ...
            <div className={style.MainContainer}>
                ...
                <div className={style.navigationMenu}>
                    ...
                    <div className={style.navHeader}>
                        ...
                        <img src={ApiService.staticImagesLocation + Data.userinfo.pictureUrl} alt="Avatar"
 ...
 pending_actions
               ...
               kid_star
                    ...
                    <div className={style.buttonContainer}>
                        ...
                        <button onClick={ShowMyItemsFragment}
                                className={Data.myItemsFragment ? style.activeFragmentBtn : style.buttonwrapper}>My
                            items
                        </button>
                        <button onClick={ShowReviewsFragment}
                                className={Data.reviewsFragment ? style.activeFragmentBtn : style.buttonwrapper}>Reviews
                        </button>
                        <button onClick={ShowChangePasswordFragment}
                                className={Data.changePasswordFragment ? style.activeFragmentBtn : style.buttonwrapper}>Change
                            Password
                        </button>
                    </div>
