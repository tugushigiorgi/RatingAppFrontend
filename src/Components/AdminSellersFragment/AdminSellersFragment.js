...
search
                ...
                <div className={style.Listwrapper}>
                    ...
                    {state.sellers.map((item) => (
                        <AdminSellersManageItem DeleteSeller={DeleteSeller} reviews={item.reviews} key={item.id}
                                                id={item.id} openModal={openModal} email={item.email}
                                                fullname={item.fullName} date={item.date} stars={item.totalRating}
